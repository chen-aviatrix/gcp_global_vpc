...
variable "assign_external_ipv6" {
  description = "Request an external ephemeral IPv6 address on the public VM. Set to false when the subnet's ipv6_access_type is INTERNAL, otherwise GCP rejects the NIC."
  type        = bool
  default     = false
}
